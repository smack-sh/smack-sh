...
const jsonHighlighterPromise: Promise<HighlighterGeneric<BundledLanguage, BundledTheme>> =
  import.meta.hot?.data.jsonHighlighterPromise ??
  (async () => {
    const { createHighlighter } = await import('shiki');
    return createHighlighter(highlighterOptions);
  })();

if (import.meta.hot) {
  import.meta.hot.data.jsonHighlighterPromise = jsonHighlighterPromise;
}
...
function JsonCodeBlock({ className, code, theme }: JsonCodeBlockProps) {
  ...
  useEffect(() => {
    let active = true;
    const render = async () => {
      const highlighter = await jsonHighlighterPromise;
