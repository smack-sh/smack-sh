...
const savedConnection = typeof window !== 'undefined' ? localStorage.getItem('supabase_connection') : null;
const savedCredentials = typeof window !== 'undefined' ? localStorage.getItem('supabaseCredentials') : null;
