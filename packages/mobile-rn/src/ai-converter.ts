...
export class ReactNativeAIConverter {
  ...
  private eventMap: Map<string, string>;
   ...
   */
  public convertWebToNative(webComponent: string): string {
   ...
   */
  private convertClassNameToStyles(component: string): string {
...
const styles = StyleSheet.create(${JSON.stringify(styles, null, 2)});`;
   ...
   */
  public generateIOSNativeBridge(moduleName: string, methods: string[]): string {
...
class ${moduleName}Bridge: NSObject {
   ...
   */
  public generateAndroidNativeBridge(moduleName: string, methods: string[]): string {
...
class ${moduleName}Bridge(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {
   ...
   */
  public generateTypeScriptInterface(moduleName: string, methods: string[]): string {
...
export const ${moduleName}Bridge = NativeModules.${moduleName}Bridge;`;
   ...
   */
  public generateExpoConfig(appName: string, bundleIdentifier: string): string {
    return `{
  "name": "${appName}",
   ...
   */
  public generateReactNavigationSetup(screens: string[]): string {
...
export function AppNavigator() {
   ...
   */
  public generatePlatformSpecificFiles(componentName: string): { ios: string; android: string } {
...
const styles = StyleSheet.create({
   ...
   */
  public generatePermissionsSetup(permissions: string[]): string {
...
export async function setupPermissions() {
   ...
   */
  public generatePushNotificationsConfig(): string {
...
export async function configurePushNotifications() {
   ...
   */
  public generateAppStoreConfig(appName: string, bundleId: string): string {
    return `{
  "ios": {
    "appName": "${appName}",
    "bundleId": "${bundleId}",
